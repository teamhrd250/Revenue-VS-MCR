...
with tab1:
    ...
    with st.expander("How to Read Management Insight Engine"):
        st.markdown("""
        - Engine ini membaca hubungan antar KPI, bukan hanya angka tunggal.
        - Contoh penting: Revenue naik tetapi RPE turun = growth dibeli dengan tambahan HC.
        - MCR rendah tetapi Capacity Risk tinggi = kemungkinan efisiensi semu karena overload.
        - Insight ini rule-based agar konsisten dan mudah dijelaskan ke Direksi.
        """)
...
with tab3:
    ...
    with st.expander("How to Read Scenario Simulator Plus"):
        st.markdown("""
        - **Max HC at Target MCR** = estimasi jumlah HC maksimum agar MCR tetap di target sehat.
        - **Revenue Required** = revenue minimum agar manpower cost saat ini masih masuk target MCR.
        - Gunakan simulasi ini sebelum menyetujui hiring atau ekspansi headcount.
        - Jika additional HC membuat MCR masuk Watch/Critical, hiring harus ditunda atau harus disertai revenue uplift yang jelas.
        """)
