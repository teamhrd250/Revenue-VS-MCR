...
def get_presentation_scale(mode: str) -> Dict[str, float]:
    """Responsive presentation scaling for laptop, monitor, and boardroom display."""
    if mode == "Compact":
        return {
            ...
            "chart_height": 470, "how_read_px": 14,
        }
    if mode == "Boardroom":
        return {
            ...
            "chart_height": 560, "how_read_px": 16.5,
        }
    return {
        ...
        "chart_height": 520, "how_read_px": 15.5,
    }
...
with st.sidebar:
    ...
    presentation_mode = st.radio(
        "Display Size",
        ["Compact", "Executive", "Boardroom"],
        index=1,
        help="Compact untuk laptop, Executive untuk monitor/meeting, Boardroom untuk TV/proyektor."
    )
    st.caption("Compact = laptop | Executive = default meeting | Boardroom = TV/proyektor.")
